    ...
    <ul className="navbar-nav ml-auto">
      ...
      <li className="nav-item dropdown no-arrow">
        ...
        <div className="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
          ...
          <a className="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal"   onClick={() => {fakeAuth.signout(() => history.push("/")); }}>
            <i className="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400" /> Logout author
          </a>
        </div>
      </li>
    </ul>
