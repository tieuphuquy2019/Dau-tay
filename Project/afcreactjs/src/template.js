  ...
  render() {
    return (
      <div>
        ...
        <link href="./ReactProject/src/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css" />
        <link href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i" rel="stylesheet" />
        {/* Custom styles for this template*/}
        <link href="./ReactProject/src/css/sb-admin-2.min.css" rel="stylesheet" />
            ...
            <div id="content">
              ...
              <div className="container-fluid">
                ...
                <div className="d-sm-flex align-items-center justify-content-between mb-4">
                  <h1 className="h3 mb-0 text-gray-800">HỆ THỐNG</h1>
                        ...
                        <div className="row no-gutters align-items-center">
                          <div className="col mr-2">
                            <div className="text-xs font-weight-bold text-primary text-uppercase mb-1">
                              <a href="./ReactProject/bsdvt.html">
                      ...
                      <div className="card-body">
                        <div className="row no-gutters align-items-center">
                          <div className="col mr-2">
                            <div className="text-xs font-weight-bold text-success text-uppercase mb-1">
                              <a href="#">
                                <h6>Thay đổi đại chỉ nhà phân phối</h6>
                              </a>
                            </div>
                          </div>
                          <div className="col-auto">
